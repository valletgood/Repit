...
export default function RegisterPage() {
  ...
  return (
    <main className="flex h-[100svh] w-full flex-col items-center bg-[#1A1A1A] px-8 pt-[calc(1rem+env(safe-area-inset-top))]">
      ...
      {/* 스크롤 영역 */}
      <section className="scrollbar-hide mt-6 flex min-h-0 w-full max-w-[383px] flex-1 flex-col gap-6 overflow-y-auto pb-8">
        {/* 회원가입 폼 */}
        <div className="flex w-full flex-col gap-4">
          ...
          {/* PASSWORD 확인 입력 */}
          <div className="flex flex-col gap-2">
            <label htmlFor="passwordConfirm" className="text-foreground-muted text-sm font-medium">
              PASSWORD CHECK
            </label>
            <div className="relative">
              <Image
